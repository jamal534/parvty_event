  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        SizedBox(height: 8.h),
        Row(
          mainAxisAlignment: isTimeBasedEvent ? MainAxisAlignment.spaceBetween : MainAxisAlignment.start,
          children: [
            Row(
              children: [
                Icon(
                  Icons.location_on,
                  color: isTimeBasedEvent ? AppColors.primaryColor : AppColors.orangeColor,
                  size: 12.r,
                ),
                SizedBox(width: 4.w),
                Text(
              ...
              Row(
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(shape: BoxShape.circle, color: Color(0xFFE8F9E1)),
                    child: Image.asset(
                      AssetPath.smsIcon,
                      width: 15.w,
                    ),
