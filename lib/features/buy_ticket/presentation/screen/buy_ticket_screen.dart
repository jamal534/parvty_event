                ...
                children: [
                  Expanded(
                    child: CustomBtn(
                      ...
                      textColor: selectTicketType.value == ticketType[0] ? Colors.white : Color(0xFF337617),
                      backgroundColor: selectTicketType.value == ticketType[0] ? AppColors.primaryColor : Color(0xFFD2F3C3),
                    ),
                  ),
                  SizedBox(width: 20.w),
                  Expanded(
                    child: CustomBtn(
                      ...
                      textColor: selectTicketType.value == ticketType[1] ? Colors.white : Color(0xFF337617),
                      onPressed: () {
                        selectTicketType.value = ticketType[1];
                        debugPrint(selectTicketType.value);
                      },
                      backgroundColor: selectTicketType.value == ticketType[1] ? AppColors.primaryColor : Color(0xFFD2F3C3),
                    ),
                  )
                ],
              ),
