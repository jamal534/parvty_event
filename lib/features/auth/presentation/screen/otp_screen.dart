                      ...
                      text: TextSpan(
                        children: [
                          TextSpan(
                            ...
                            style: TextStyle(color: const Color(0xFF1A202C), fontWeight: FontWeight.w400, fontSize: 14.sp),
                          ),
                          TextSpan(
                            text: secondsRemaining.value == 0.0 ? "" : "${secondsRemaining.value.toStringAsFixed(2)}",
                            style: TextStyle(fontWeight: FontWeight.w600, fontSize: 14.sp, color: const Color(0xFF4EB323)),
                          ),
                        ],
                      ),
                    ),
