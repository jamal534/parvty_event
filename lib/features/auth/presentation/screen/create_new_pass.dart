          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                ...
                style: GoogleFonts.inter(fontSize: 16.sp, fontWeight: FontWeight.w400, color: Color(0xFF718096C)),
              ),
              SizedBox(
                height: 20.h,
              ),
              CustomTextField(
                ...
                hintStyle: GoogleFonts.inter(fontWeight: FontWeight.w400, fontSize: 14.sp, color: Color(0xFF718096)),
              ),
              SizedBox(
                height: 10.h,
              ),
              CustomTextField(
                ...
                validator: (value) => FormValidation.validatePasswordMatch(value, authenticationController.newPassword),
