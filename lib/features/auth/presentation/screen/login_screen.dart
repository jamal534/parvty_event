          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                Text(
                  "Hey! Welcome back",
                  style: GoogleFonts.inter(fontSize: 24.sp, fontWeight: FontWeight.w600, color: Color(0xFF1A202C)),
                ),
                Text(
                  "Sign In to your account",
                  style: GoogleFonts.inter(fontSize: 14.sp, fontWeight: FontWeight.w400, color: Color(0xFF718096)),
                ),
                SizedBox(
                  height: 20.h,
                ),
                CustomTextField(
                  textEditingController: authenticationController.logInEmailController,
                  ...
                  hintText: "Email",
                  hintStyle: GoogleFonts.inter(fontWeight: FontWeight.w400, fontSize: 16.sp, color: Color(0xFF718096)),
                ),
                SizedBox(
                  height: 10.h,
                ),
                CustomTextField(
                  textEditingController: authenticationController.logInPasswordController,
                ...
                Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        "Remember Me",
                        style: GoogleFonts.inter(fontSize: 12.sp, fontWeight: FontWeight.w400, color: Color(0xFF20222C)),
                    ...
                    Row(
                      children: [
                        InkWell(
                          ...
                          child: Text(
                            "Forgot Password?",
                            style: GoogleFonts.inter(fontWeight: FontWeight.w600, fontSize: 14.sp, color: Color(0xFF4EB323)),
                          ),
                        )
                      ],
                    ),
                ...
                Container(
                  ...
                  child: ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      ...
                      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12.r), side: BorderSide(width: 1.w, color: Color(0xFFE2E8F0))),
                    ),
                    child: Row(
