                  ...
                  Row(
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(borderRadius: BorderRadius.circular(35), color: AppColors.lightPrimaryColor),
                        child: Image.asset(
                      ...
                      Column(
                        ...
                        children: [
                          Text(
                            'Booking Successful!',
                            style: GoogleFonts.inter(fontSize: 16.sp, fontWeight: FontWeight.w600, color: AppColors.darkGrey),
                          ),
                          SizedBox(height: 5.h),
                          IntrinsicHeight(
                            child: Row(
                              children: [
                                Text(
                                  '20 Dec, 2022',
                                  style: GoogleFonts.inter(fontSize: 12.sp, fontWeight: FontWeight.w400, color: AppColors.secondaryColor),
                                ),
                                VerticalDivider(
                      ...
                      isNew == false
                          ? Padding(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(borderRadius: BorderRadius.circular(8.r), color: AppColors.primaryColor),
                                child: Text(
                                  'New',
                                  style: GoogleFonts.inter(color: Colors.white, fontSize: 10.sp, fontWeight: FontWeight.w600),
                                ),
                              ),
                            )
                          : Container(),
