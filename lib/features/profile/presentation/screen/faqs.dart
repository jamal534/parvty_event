        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            return Obx(() => Column(
                  children: [
                    Container(
                      decoration: BoxDecoration(borderRadius: BorderRadius.circular(8.r), color: Color(0xFFF9F9FB), border: Border.all(color: Colors.transparent)),
                      child: ExpansionTile(
                        ...
                        title: Padding(
                          ...
                          child: Text(
                            index == 0 ? 'How To use booking system' : 'You want your order into your home?',
                        ...
                        trailing: Padding(
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                              ...
                              border: Border.all(width: 2.w, color: Color(0xFF4EB323)),
                            ),
                            child: Icon(
