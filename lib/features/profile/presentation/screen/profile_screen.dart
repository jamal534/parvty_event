...
class ProfileScreen extends StatelessWidget {
  ...
  final List<Map<String, dynamic>> proFile = [
    {'image': AssetPath.notification, 'title': 'Notifications', 'icon': Icons.arrow_forward_ios_rounded},
    {'image': AssetPath.editProfile, 'title': 'Edit profile', 'icon': Icons.arrow_forward_ios_rounded},
    {
