                              ...
                              Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(height: 10.h),
                                    PaymentTextfield(
                                      textEditingController: paymentMethodController.cardNumberController,
                                        ...
                                        Expanded(
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              SizedBox(height: 10.h),
                                              PaymentTextfield(
                                                textEditingController: paymentMethodController.expiryDateController,
                                                hintText: '06/23',
                                        ...
                                        Expanded(
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              SizedBox(height: 10.h),
                                              PaymentTextfield(
                                                textEditingController: paymentMethodController.cvvController,
                                                hintText: '483',
                  ...
                  () => Padding(
                    ...
                    child: Options(
                      ...
                      onPressed: () {
                        ...
                        debugPrint("Selected language: ${paymentMethodType[index]['title']}");
                      },
                                ...
                                Obx(
                                  () => Container(
                                    decoration: BoxDecoration(
                                      ...
                                      border: Border.all(
                                        width: 1.5.w,
                                        color: selectSavedCard.value ? AppColors.primaryColor : Color(0xFFE2E8F0),
                                      ),
                                    ),
                                    child: Padding(
                                      ...
                                      child: Icon(
                                        Icons.circle,
                                        size: 14.r,
                                        color: selectSavedCard.value ? AppColors.primaryColor : Colors.white,
                                      ),
                                    ),
                                  ),
                                ),
                            ...
                            Obx(
                              () => Padding(
                                ...
                                child: Options(
                                  ...
                                  fontSize: 14.sp,
                                  onPressed: () {
                                    selectSavedCard.value = !selectSavedCard.value;
                                  },
