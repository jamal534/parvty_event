                                  ...
                                  children: [
                                        ...
                                        children: [
                                          ...time.map(
                                            (e) => Expanded(
                                              child: GestureDetector(
                                                onTap: () {
                                                  selectedTimeItem.value = time.indexOf(e) + 1;
                                                  print(selectedTimeItem);

                                                  if (selectedTimeItem.value == 0) {
                                                    Get.snackbar('Select Time', 'Please select a time to show!', snackPosition: SnackPosition.BOTTOM);
                                                  }
                                                },
                                                child: Obx(
                                                  () => Container(
                                                    ...
                                                    decoration: BoxDecoration(
                                                      color: selectedTimeItem.value == time.indexOf(e) + 1 ? AppColors.primaryColor : Color(0xFFF6F6F6),
                                                    ...
                                                    child: Center(
                                                      child: Text(
                                                        ...
                                                        style: GoogleFonts.inter(
                                                            fontSize: 12.sp, fontWeight: FontWeight.w500, color: selectedTimeItem.value == time.indexOf(e) + 1 ? Colors.white : Color(0xFF4A5568)),
                                                      ),
                                                    ),
                                                  ),
                                                ),
                                    ...
                                    Padding(
                                      ...
                                      child: CustomTextFormField(
                                        ...
                                        trailingIcon: AssetPath.calendarIconFill,
                                      ),
                                    ),
                                    SizedBox(height: 16.h),
                                    Padding(
