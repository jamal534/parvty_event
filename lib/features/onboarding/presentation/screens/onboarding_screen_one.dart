                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: AssetImage(
                          onboardingController.onboardingData[onboardingController.currentIndex.value]['image']!,
                        ),
                        fit: BoxFit.cover,
                      ),
                    ),
                        ...
                        Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              Text(
                                onboardingController.onboardingData[onboardingController.currentIndex.value]['title']!,
                              ...
                              Text(
                                onboardingController.onboardingData[onboardingController.currentIndex.value]['description']!,
                                textAlign: TextAlign.center,
                                style: GoogleFonts.inter(
                                  fontSize: 14.sp,
                                  ...
                                  (i) => Padding(
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        ...
                                        color: i == onboardingController.currentIndex.value ? Color(0xFF337617) : Color(0xFFD2F3C3),
                                      ),
                                    ),
                                  ),
                                ),
                            ...
                            child: ElevatedButton(
                              ...
                              style: ElevatedButton.styleFrom(
                                ...
                                shape: RoundedRectangleBorder(
                                  ...
                                  side: BorderSide(width: 2.w, color: Color(0xFF333333)),
                                ),
                              ),
                              child: Text(
                                "Sign In",
                      ...
                      child: Column(
                        children: [
                          ...
                          CustomBtn(
                            text: "Next",
                            onPressed: () {
                              print("Current Index: ${onboardingController.currentIndex.value}");
