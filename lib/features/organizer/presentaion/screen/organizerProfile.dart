...
class Organizerprofile extends StatelessWidget {
  ...
  final List<Map<String, dynamic>> proFile = [
    {'image': AssetPath.editProfile, 'title': 'Profile', 'icon': Icons.arrow_forward_ios_rounded},
    {'image': AssetPath.wallet, 'title': 'Payments', 'icon': Icons.arrow_forward_ios_rounded},
    {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(title: 'Profile', isTrailingEnabled: false, centerTitle: false),
      body: Column(
        children: [
          Stack(
            children: [
                  ...
                  child: ListTile(
                    ...
                    title: Text(
                      ...
                      style: GoogleFonts.inter(
                        ...
                        fontSize: 16.sp,
                        color: isLogout ? AppColors.primaryColor : Color(0xFF2D2D2D),
                      ),
                    ),
