            ...
            children: [
              ...
              Center(
                child: Container(
                  ...
                  decoration: BoxDecoration(border: Border.all(color: Color(0x33718096)), borderRadius: BorderRadius.circular(20.r)),
                  child: Padding(
                              ...
                              () => Container(
                                ...
                                child: DropdownButtonHideUnderline(
                                  child: DropdownButton<String>(
                                    value: earningsController.earningsSelectedValue.value,
                                    isExpanded: true,
                                    icon: Icon(Icons.arrow_drop_down, color: Colors.black),
                                    items: earningsController.earningsSelectedItems.map((String value) {
                                    ...
                                    onChanged: (String? newValue) {
                                      earningsController.earningsSelectedValue.value = newValue!;
                                    },
                                  ),
                                ),
                              ),
