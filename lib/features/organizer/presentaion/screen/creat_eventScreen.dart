          ...
          child: Column(
            ...
            children: [
              ...
              CustomTextField1(
                ...
                hintStyle: GoogleFonts.inter(color: Color(0xFF4A5568), fontWeight: FontWeight.w400, fontSize: 12.sp),
              ...
              Obx(
                () => CustomTextField1(
                  ...
                  hintStyle: GoogleFonts.inter(color: AppColors.darkBlueGrey, fontWeight: FontWeight.w500, fontSize: 12.sp),
                  fillColor: Colors.white,
                  isEnabled: false,
                  suffixIcon: Padding(
                    padding: EdgeInsets.symmetric(horizontal: 16.h),
