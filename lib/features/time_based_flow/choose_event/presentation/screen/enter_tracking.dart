                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            SizedBox(width: 8.w),
                            CustomTextIner(
                              text: controller.switchBtn.value ? 'Clocked In' : 'Clocked Off',
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        Expanded(
                                          child: myContainer(Color(0xFFF1F2F5), 'Time Spent', '03:24 Hr'),
                                        ),
                                        SizedBox(width: 30.w),
                                        Expanded(
                                          child: myContainer(Color(0xFFFFE8D8), 'Current Cost', '\$15. USD'),
                                        ),
                                      ],
                                    ),
                                  ],
                ...
                child: CircleAvatar(
                  ...
                  child: CircleAvatar(
                    ...
                    child: GestureDetector(
                      onTap: () {
                        controller.switchBtn.value = (!controller.switchBtn.value);
                      ...
                      child: CircleAvatar(
                        ...
                        backgroundColor: AppColors.lightGreen,
                        child: Image.asset(
                          controller.switchBtn.value ? AssetPath.pauseIcon : AssetPath.playIcon,
                          width: 24.w,
                          color: Colors.white,
                        ),
                      ),
