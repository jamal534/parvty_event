            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text(
                    'Hi Welcome',
                    style: GoogleFonts.inter(fontSize: 10.sp, color: AppColors.secondaryColor),
                    overflow: TextOverflow.ellipsis,
                  ),
                  Text(
                    'MD Rafi Islam',
                    style: GoogleFonts.inter(fontSize: 12.sp, color: AppColors.darkGrey, fontWeight: FontWeight.w500),
                    overflow: TextOverflow.ellipsis,
                  ),
                ],
              ),
                ...
                children: [
                  ...
                  Positioned(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        shape: BoxShape.circle,
                        color: AppColors.primaryColor, // Active notification color
                        border: Border.all(
                          color: Colors.white,
                          width: 1.w,
                        ),
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Spacer(),
                    TextButton(
                        onPressed: () => Get.toNamed(AppRoute.allFeaturedScreen),
                        child: Text(
                          'View All',
                          style: GoogleFonts.inter(fontSize: 10.sp, color: AppColors.primaryColor),
                        ))
                  ],
                ),
