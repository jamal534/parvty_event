    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Disco - Party 2024',
            style: TextStyle(fontSize: 14.sp, fontWeight: FontWeight.w600, color: AppColors.darkGrey),
          ),
          SizedBox(height: 5.h),
          Text(
            '   Pay 10% upfront + \$0.30\n per minute',
            ...
            maxLines: 2,
            style: TextStyle(fontSize: 10.sp, overflow: TextOverflow.ellipsis, fontWeight: FontWeight.w400, color: AppColors.darkGrey),
          ),
          SizedBox(height: 8.h),
          Container(
            width: 139.sp,
