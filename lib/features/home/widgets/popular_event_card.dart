...
class PopularEventCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      margin: isMargin.value ? EdgeInsets.symmetric(vertical: 7.h, horizontal: 16.h) : EdgeInsets.zero,
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Disco - Party 2024',
                        style: GoogleFonts.inter(fontSize: 14.sp, fontWeight: FontWeight.w600, color: AppColors.darkGrey),
                      ),
                      ...
                      Row(
                        ...
                        children: [
                          Text(
                            '03 October, 22',
                            style: GoogleFonts.inter(fontSize: 10.sp, fontWeight: FontWeight.w400, color: AppColors.darkGrey),
                          ),
                          SizedBox(width: 5.w),
                          Icon(
                            Icons.circle,
                                          ...
                                          children: [
                                            Stack(
                                              ...
                                              children: [
                                                ...
                                                buildAvatar(AssetPath.personTwo, 11.w),
                                                buildAvatar(AssetPath.personOne, 22.w),
                                                buildAvatar(AssetPath.personTwo, 33.w),
                                                Positioned(
                                                  left: 44.w,
                                                  child: Container(
                                                    decoration: BoxDecoration(
                            ...
                            Obx(
                              () => isOrganizer.value == true
                                  ? GestureDetector(
                                      ...
                                      child: Container(
                                        decoration: BoxDecoration(borderRadius: BorderRadius.circular(4.r), color: Color(0xFFD2F3C3)),
                                        child: Center(
                                          child: Padding(
